Custom profile folders v.0.1.6.1
...
version 0.1.6.1 - 2012/05/24
	! Fixed m_folders.h declarations in unicode mode again - thanks Freak_TheMighty.
	! The m_folder.h FoldersGetCustomPathW, FoldersGetCustomPathExW did not behave like the ANSI versions, they did not convert a relative path to absolute.
	! The Unicode version of the helper methods are only available if _UNICODE is defined, this is because the relative to absolute Unicode methods in the core are only availabe in the Unicode build.
